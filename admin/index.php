                ...
                <div class="col-md-3 stretch-card grid-margin">
                    <div class="card bg-gradient-success card-img-holder text-white">
                        <div class="card-body" style="padding: 1.5rem;">
                            <img src="<?= BASE_PATH ?>/admin/assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                                    ...
                                    <tbody>
                                        <?php if ($result_main && $result_main->num_rows > 0): ?>
                                            <?php while($row = $result_main->fetch_assoc()): ?>
                                                <tr>
                                                    <td>
                                                        <img src="<?= BASE_PATH ?>/admin/assets/images/faces/face1.jpg" class="me-2" alt="image">
