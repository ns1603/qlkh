                ...
                <div class="video-wrapper">
                    ...
                    ?>
                            <video controls controlsList="nodownload" oncontextmenu="return false;">
                                <source src="<?= BASE_PATH ?>/<?= $vid_url ?>" type="video/mp4">
                ...
                <?php if (!empty($current_lesson['audio_url'])): ?>
                    <div class="audio-box">
                        ...
                        <audio controls style="width: 100%;">
                            <source src="<?= BASE_PATH ?>/<?= $current_lesson['audio_url'] ?>" type="audio/mpeg">
                    ...
                    <?php if (!empty($current_lesson['attachment'])): ?>
                        <div class="attachment-box">
                            ...
                            <div>
                                ...
                                <a href="<?= BASE_PATH ?>/<?= $current_lesson['attachment'] ?>" target="_blank" class="text-primary text-decoration-none">
